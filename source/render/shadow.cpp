...
void InitShadows()
{
#ifdef PLATFORM_GLES20	//OpenGL 3.0 way
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8_OES, DEPTH_SIZE, DEPTH_SIZE, 0, GL_RGBA, GL_UNSIGNED_SHORT, 0);
...
#ifdef PLATFORM_GL14 //OpenGL 1.4 way
    glGenTextures(1, &g_depth);
    glBindTexture(GL_TEXTURE_2D, g_depth);
