...
void BlView::regen(Selection* sel)
{
	...
	int f, int style, void (*reframef)(Widget* w), void (*click)(), void (*click2)(int p), void (*overf)(), void (*overf2)(int p), void (*out)(), int parm);
	#endif
			char orderstr[128];
