...
unsigned int rand3()
{
	...
	const unsigned int bit01mask = 1 << 1;
	...
	unsigned int newbit01 = oldbit00 << 1;
...
static unsigned int m_w = 1;    /* must not be zero, nor 0x464fffff */
static unsigned int m_z = 1;    /* must not be zero, nor 0x9068ffff */
