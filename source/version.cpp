...
void ParseVer(unsigned long long number, unsigned char* major, unsigned char* featureset, unsigned char* attempt, unsigned char* status, unsigned char* postrelease)
{
